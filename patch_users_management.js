...
// 1. Fix Modal container layout for mobile
code = code.replace(
...
// 2. Fix slug input layout
const slugInputTarget = `<div className="flex items-center bg-white border border-slate-200 rounded-xl overflow-hidden focus-within:border-teal-500 focus-within:ring-1 focus-within:ring-teal-500 transition-all shadow-xs">
...
const slugInputReplace = `<div className="flex flex-col sm:flex-row sm:items-center bg-white border border-slate-200 rounded-xl overflow-hidden focus-within:border-teal-500 focus-within:ring-1 focus-within:ring-teal-500 transition-all shadow-xs">
