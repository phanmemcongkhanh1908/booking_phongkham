    ...
    <div className="space-y-6">
      ...
      {filteredServices.length === 0 ? (
        <div className="rounded-3xl border border-dashed border-slate-200 bg-slate-50 p-10 text-center space-y-3">
          ...
          <h3 className="font-bold text-slate-700">Không tìm thấy dịch vụ phù hợp</h3>
          ...
          <button
            ...
            className="px-4 py-2 rounded-xl bg-white border border-slate-200 text-xs font-bold text-teal-700 shadow-xs hover:bg-slate-50"
          >
            ...
            return (
              <button
                ...
                className={`group relative text-left rounded-2xl border p-4 sm:p-5 transition-all duration-300 flex flex-col justify-between overflow-hidden cursor-pointer ${
                  isSelected 
                    ? 'border-teal-600 bg-teal-50/40 ring-2 ring-teal-600/30 shadow-md' 
              ...
              >
                ...
                <div className="flex items-center justify-between gap-2 w-full mb-3">
                  <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-[11px] font-bold tracking-tight bg-slate-100 text-slate-600 group-hover:bg-teal-50 group-hover:text-teal-700 transition-colors">
                    {cat.icon}
                    <span>{cat.label}</span>
                  </span>
                ...
                <div className="pt-3 border-t border-slate-100 flex items-center justify-between gap-2 w-full text-xs">
                  ...
                  <div className="text-right">
                    <span className="font-extrabold text-sm sm:text-base text-teal-700 group-hover:text-teal-800">
                      {formattedPrice}
                    </span>
                  </div>
                </div>
